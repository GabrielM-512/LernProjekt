...
This file should (!!!) be identical in every subdirectory which has some kind of .php script, as it dynamically finds prepend_global.php and thus will find it as long as there it is mounted at /backend.
...
while (!file_exists($dir . '/prepend_global.php')) {
    ...
    // Check if the root of the filesystem has been reached. The check must be made since if prepend.php is placed outside of /backend and its subdirectories,
...
// finally, include prepend_global.php to make is accessible to the calling script

...
It provides the option to not instantly connect to the database itself and instead just connect to the server by creating the variable $setDB and setting it to True prior to including this file.
*/
